...
<head>
  ...
  <link rel="stylesheet" href="../css/vve.css">
      ...
      <div class="dienstverlening-container">
        <div class="dienstverlening-content">
          ...
          <div class="dienstverlening-tekst">
            <h2>VvE diensten Limburg ontzorgt!</h3><br>
              <p>Het beheer van uw Vereniging van Eigenaars is bij VvE Diensten Limburg in deskundige handen. Wij
                verzorgen het complete dienstenpakket van uw VvE.<br>
                <br>
                VvE Diensten Limburg heeft alle diciplines in huis: <br>
                - financieel beheer <br>
                - administratief beheer <br>
                - technisch beheer <br>
                - boukundig beheer <br>
                <br>
                Het volledige beheer onder één dak: korte lijnen, informeel en vaste aanspreekpunten.
              </p>
              <br>
          </div>
